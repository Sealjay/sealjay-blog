...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        ink: {
          950: '#0C0A1D', 900: '#110E26', 850: '#17132E', 800: '#1E1A3A',
          700: '#2A2550', 600: '#6670A0', 500: '#9BA3CF', 400: '#B8BFE0',
          300: '#D0D5EB', 200: '#E0E7FF', 100: '#EEF2FF', 50: '#F8F9FC',
        },
        paper: {
          50: '#F8F9FC', 100: '#EEEEF8', 200: '#E4E3F2', 300: '#D4D2E8',
        },
        indigo: {
          DEFAULT: '#818CF8', 50: '#EEF2FF', 100: '#E0E7FF', 200: '#C7D2FE',
          300: '#A5B4FC', 400: '#818CF8', 500: '#6366F1', 600: '#4F46E5',
          700: '#4338CA', 800: '#3730A3', 900: '#312E81', 950: '#1E1B4B',
        },
        rose: {
          DEFAULT: '#F472B6', 50: '#FFF1F2', 100: '#FFE4E6', 200: '#FECDD3',
          300: '#FDA4AF', 400: '#FB7185', 500: '#F472B6', 600: '#DB2777', 700: '#BE185D',
        },
