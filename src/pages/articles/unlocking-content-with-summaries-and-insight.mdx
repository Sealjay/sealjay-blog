...
export const meta = {
  ...
  slug: 'unlocking-content-with-summaries-and-insight',
}
...
![](__GHOST_URL__/content/images/2021/02/cogsearchdesign.png)

![](__GHOST_URL__/content/images/2021/02/cogsearchmain.png)

![](__GHOST_URL__/content/images/2021/02/cogsearchoverview.png)

This is an anonymised set of screenshots to demonstrate the application (used with permission from Avanade Inc)

### How does it work?

![](__GHOST_URL__/content/images/2021/02/cognitive_search_application.png)

Generated with [Diagrams for Python](https://diagrams.mingrammer.com/)

### Getting the documents into Blob Storage
...
<figure class="kg-card kg-image-card kg-card-hascaption">
  <img
    src="__GHOST_URL__/content/images/2021/02/image-21.png"
    class="kg-image"
    alt
    loading="lazy"
    width="1236"
    height="244"
    srcset="__GHOST_URL__/content/images/size/w600/2021/02/image-21.png 600w, __GHOST_URL__/content/images/size/w1000/2021/02/image-21.png 1000w, __GHOST_URL__/content/images/2021/02/image-21.png 1236w"
    sizes="(min-width: 720px) 720px"
  />
  <figcaption>The Document Cracking Pipeline for this Solution</figcaption>
</figure>
<script src="https://gist.github.com/Sealjay-clj/428a5b9451241b7247abc8a1a718af0f.js"></script>
<p>
  And there we have it! I hope this example showed you how easy it is to set up
  and use Azure Cognitive Search to create intelligent applications, and extract
  that is currently trapped in your documents.
</p>
<figure class="kg-card kg-image-card kg-card-hascaption">
  <img
    src="__GHOST_URL__/content/images/2021/02/cogsearchoverview-1.png"
    class="kg-image"
    alt
    loading="lazy"
    width="543"
    height="447"
  />
  <figcaption>The search results for our knowledge finder example</figcaption>
</figure>

I showed you how Cognitive Services and Agolo could be used to summarise documents

- and in a future post, I'll explain [how to use Azure Media Services Video Indexer](https://docs.microsoft.com/en-us/azure/media-services/video-indexer/video-indexer-overview)
  to pull insight out of video and audio files.

<figure class="kg-card kg-image-card kg-card-hascaption">
  <img
    src="__GHOST_URL__/content/images/2021/02/image-23.png"
    class="kg-image"
    alt
    loading="lazy"
    width="419"
    height="267"
  />
  <figcaption>The information pyramid</figcaption>
</figure>
<p></p>
