...
export const meta = {
  ...
  date: '2022-01-12T11:03:59.000Z',
  tags: ['External Media'],
  title: 'GitHub Copilot – GPT-3 powered coding',
  slug: 'github-copilot-gpt-3-powered-coding',
}
...
<figure class="kg-card kg-bookmark-card kg-card-hascaption">
  <a class="kg-bookmark-container" href="https://copilot.github.com">
    <div class="kg-bookmark-content">
      ...
      <div class="kg-bookmark-metadata">
        <img
          ...
          alt=""
        />
        <span class="kg-bookmark-author">GitHub Copilot</span>
      </div>
    </div>
    <div class="kg-bookmark-thumbnail">
      <img src="http://copilot.github.com/social.png" alt="" />
    </div>
  </a>
  <figcaption>Join the preview program!</figcaption>
</figure>
<p></p>
