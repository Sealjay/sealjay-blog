...
> **Update (February 2026):** The approach described below still works — Flow Bot and the [Power Automate Teams connector](https://learn.microsoft.com/en-us/connectors/teams/?WT.mc_id=AI-MVP-5004204) remain supported. Note that the Power Automate UI has changed significantly since 2021 (the designer has been rebuilt), so the screenshots may not match the current interface. Separately, [Office 365 Connectors in Teams are being retired](https://learn.microsoft.com/en-us/microsoftteams/m365-custom-connectors?WT.mc_id=AI-MVP-5004204) (final deadline April 2026) — this affects webhook-based incoming connectors, not the Power Automate Teams actions used here.
