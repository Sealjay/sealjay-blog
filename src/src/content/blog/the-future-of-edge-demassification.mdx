...
[NASA’s JPL uses Microsoft’s Azure Quantum to manage communication with space missions - Microsoft Azure Quantum BlogAs NASA launches more frequent and complex missions into space, managing communications with the growing number of spacecraft is becoming increasingly challenging. NASA’s Jet Propulsion Laboratory (JPL) has turned to Azure Quantum to explore ways to communicate more efficiently with spacecraft explo…![](https://cloudblogs.microsoft.com/uploads/prod/sites/7/2018/08/cropped-cropped-microsoft_logo_element-300x300.png)Microsoft Azure Quantum BlogAnita Ramanan![](https://cloudblogs.microsoft.com/uploads/prod/sites/7/2022/01/MS_JPL_QuatComp_Thumbnail_02_.png)](https://cloudblogs.microsoft.com/quantum/2022/01/27/nasas-jpl-uses-microsofts-azure-quantum-to-manage-communication-with-space-missions/)
