...
description: "Part 1 of my series on using Azure Cognitive Search to make UK legislation more accessible, covering indexer setup and document cracking."
...
Azure Cognitive Search takes your data, wherever it may be - from SQL Server Data, through to Blob Storage, and [SharePoint Online](https://learn.microsoft.com/en-us/azure/search/search-howto-index-sharepoint-online?WT.mc_id=AI-MVP-5004204).
