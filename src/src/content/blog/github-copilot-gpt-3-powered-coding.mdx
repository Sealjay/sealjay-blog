...
description: "I co-authored a blog for Avanade on GitHub Copilot, exploring its GPT-3 powered code suggestions, productivity benefits, and potential pitfalls."
...
> **Update (February 2026):** The original Avanade blog links are no longer available. Avanade retired all employee-written blogs in 2025. The Techs and Specs link above points to an archived copy on the Wayback Machine. The intelligent code creation article has no archived copy — the excerpts on [this blog post](/blog/ethical-and-productivity-implications-of-intelligent-code-creation) are the last remaining copy. Additionally, [GitHub Copilot](https://learn.microsoft.com/en-us/copilot/github/about-github-copilot-individual?WT.mc_id=AI-MVP-5004204) has evolved dramatically since this article — it is now generally available across multiple tiers (Free, Pro, Business, Enterprise), supports a range of models including GPT-4.1, Claude, and Gemini (no longer GPT-3/Codex), and includes chat, agent mode, code review, and IDE-integrated features far beyond the original line completions described here.
