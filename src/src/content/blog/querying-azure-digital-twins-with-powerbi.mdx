...
> **Update (February 2026):** The Python scripting approach described below still works for querying the current state of your twins. However, for production dashboards and historical analysis, Microsoft now recommends using [Azure Digital Twins Data History](https://learn.microsoft.com/en-us/azure/digital-twins/concepts-data-history?WT.mc_id=AI-MVP-5004204) to automatically historise graph updates to [Azure Data Explorer](https://learn.microsoft.com/en-us/azure/digital-twins/how-to-use-data-history?WT.mc_id=AI-MVP-5004204), and then connecting Power BI via the [native Azure Data Explorer connector](https://learn.microsoft.com/en-us/azure/data-explorer/power-bi-data-connector?WT.mc_id=AI-MVP-5004204). This gives you time-series history, better scalability, DirectQuery support, and no custom Python code to maintain. The [companion repository](https://github.com/Sealjay/powerbi-adt) remains archived for reference.
...
[Sealjay/powerbi-adtQuerying Azure Digital Twins with PowerBI. Contribute to Sealjay/powerbi-adt development by creating an account on GitHub.![](https://github.githubassets.com/favicons/favicon.svg)GitHubSealjay![](https://opengraph.githubassets.com/9642f68c9fffaf41f7353e8263423950fa92f07d6101da79bcb0d37bb2bd9eea/Sealjay/powerbi-adt)](https://github.com/Sealjay/powerbi-adt)### How do I pull my twins into PowerBI?
...
8. Import the **powerbi-query.py** file in the [GitHub repository](https://github.com/Sealjay/powerbi-adt) as a [PowerBI datasource](https://docs.microsoft.com/en-us/power-bi/connect-data/desktop-python-scripts?WT.mc_id=AI-MVP-5004204#run-your-python-script-and-import-data).
...
For a full example, [you can see the repository on GitHub](https://github.com/Sealjay/powerbi-adt).
