...
tags: ['Cognitive Services', 'API', 'How To', 'Cognitive Search', 'Text Analytics', 'Agolo']
---
...
![](__GHOST_URL__/content/images/2021/02/cogsearchdesign.png)![](__GHOST_URL__/content/images/2021/02/cogsearchmain.png)![](__GHOST_URL__/content/images/2021/02/cogsearchoverview.png)This is an anonymised set of screenshots to demonstrate the application (used with permission from Avanade Inc) ### How does it work?

![](__GHOST_URL__/content/images/2021/02/cognitive_search_application.png)Generated with [Diagrams for Python](https://diagrams.mingrammer.com/)### Getting the documents into Blob Storage
...
![](__GHOST_URL__/content/images/2021/02/image-21.png)The Document Cracking Pipeline for this SolutionAnd there we have it! I hope this example showed you how easy it is to set up and use Azure Cognitive Search to create intelligent applications, and extract that is currently trapped in your documents.

![](__GHOST_URL__/content/images/2021/02/cogsearchoverview-1.png)The search results for our knowledge finder exampleI showed you how Cognitive Services and Agolo could be used to summarise documents - and in a future post, I'll explain [how to use Azure Media Services Video Indexer](https://docs.microsoft.com/en-us/azure/media-services/video-indexer/video-indexer-overview) to pull insight out of video and audio files.

![](__GHOST_URL__/content/images/2021/02/image-23.png)The information pyramid