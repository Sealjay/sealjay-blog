...
## ![](/images/2021/03/image-18.png)An example of a very basic Adaptive Card, just saying hi!How do we do it?
...
## ![](/images/2021/03/image-22.png)You can see the recurrence trigger, the adaptive card, the email content, and the title.Looping over the users
