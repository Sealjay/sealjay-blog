...
[Microsoft Azure Confidential Ledger overviewAn overview of Azure Confidential Ledger, a highly secure service for managing sensitive data recordsMicrosoft Docsmsmbaldwin![](https://docs.microsoft.com/en-us/media/logos/logo-ms-social.png)](https://docs.microsoft.com/en-us/azure/confidential-ledger/overview?WT.mc_id=AI-MVP-5004204)