...
[Unlocking content using Azure Cognitive Search, and AgoloUsing Azure Cognitive Search to index information within a document store, and make it more easily comprehensible & accessible![](https://sealjay.com/favicon.png)SealjayChris Lloyd-Jones![](__GHOST_URL__/content/images/2021/02/cogsearchmain-1.png)](https://sealjay.com/unlocking-content-with-summaries-and-insight/)The problem with a pure keyword search, is that computers don't understand the context they're operating in. If you search for an orange, you'll get results for the fruit, mixed in with the colour.
