...
tags: ['How To', 'Cognitive Services', 'CLI', 'Python', 'Digital Twins', 'PowerBI', 'Anomaly Detector']
---
...
![](__GHOST_URL__/content/images/2021/05/image-1.png)A screenshot of the graph database within the Azure Digital Twins explorer### Sharing data with end users
...
![](__GHOST_URL__/content/images/2021/05/image-2.png)The list of twins displayed in PowerBI